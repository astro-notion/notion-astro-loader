...
- [x] 5.3 Create annotated tag `v2.0.0-beta.1` on the matching `main` commit and atomically push `main` and the tag after maintainer approval.
- [x] 5.4 Verify npm keeps `latest` at `1.1.2`, sets `next` to `2.0.0-beta.1`, displays provenance, and GitHub creates a generated prerelease.
- [x] 5.5 Remove any obsolete npm publication secret after the trusted-publishing release succeeds.

# Capability: Asset Handling

## Purpose

Download and cache Notion-hosted assets, resolve destination-specific paths, and provide shared diagnostics for source and public asset handling.
